...
This module contains :class:`chad_demography_adult_non_work.CHAD_demography_adult_non_work`.
"""
...
# ===========================================
# class CHAD_demography_adult_non_work
# ===========================================

class CHAD_demography_adult_non_work(chad_demography.CHAD_demography):

    """
    This class contains the common functionality with accessing the CHAD data files
    relevant to non-working adult demographic.

    :var keys: the ABMHAP activity codes for the activities simulated by the non-working adult demographic
    ...
    def __init__(self):
        ...
        chad_demography.CHAD_demography.__init__(self, dmg.ADULT_NON_WORK)
        ...
        # the file names for CHAD longitudinal data for each activity
        ...
        #
        # default parameters for sampling the CHAD data
        #
