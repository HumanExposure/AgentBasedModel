...
This module contains :class:`chad_demography_adult_work.CHAD_demography_adult_work`.
"""
...
# ===========================================
# class CHAD_demography_adult_work
# ===========================================

class CHAD_demography_adult_work(chad_demography.CHAD_demography):

    """
    This class contains the common functionality with accessing the CHAD data files
    relevant to working adult demographic.

    :var keys: the ABMHAP activity codes for the activities simulated by the working adult demographic
    ...
    :var chad_params.CHAD_params 'work': sampling parameters for working activity within CHAD
    ...
    def __init__(self):
        ...
        chad_demography.CHAD_demography.__init__(self, dmg.ADULT_WORK)
        ...
        self.fname_stats = {mg.KEY_COMMUTE_FROM_WORK: self.fname_stats_commute_from_work,
                            ...
                            mg.KEY_WORK: self.fname_stats_work,
                            }
        #
        ...
        self.eat_dinner         = cp.CHAD_params(dt_mean_min=self.eat_dinner_dt_mean_min, \
                                                 ...
                                                 start_std_max=self.eat_dinner_start_std_max, \
        ...
        # default parameters for sampling work data
        self.work               = cp.CHAD_params(start_mean_min=self.work_start_mean_min, \
                                                 start_mean_max=self.work_start_mean_max, \
                                                 start_std_max=self.work_start_std_max, \
                                                 end_mean_min=self.work_end_mean_min, \
                                                 end_mean_max=self.work_end_mean_max, \
                                                 end_std_max=self.work_end_std_max, \
                                                 dt_mean_min=self.work_dt_mean_min, \
                                                 dt_mean_max=self.work_dt_mean_max, \
                                                 dt_std_max=self.work_dt_std_max,\
                                                 N=self.n_work, \
                                                 do_start=True, do_end=True, do_dt=True)
